...
export function SingleBlogItem({ title, description, slug, date }) {
    ...
    return (<div className="py-4 group">
        <Link href={`/blog/${slug}`}>
            <div className="cursor-pointer">
                ...
                {/* </Link> */}
                <div className='text-sm text-slate-600 mb-2 dark:text-slate-400'>{format(parseISO(date), 'MMMM do, uuu, HH:mm:ss')}</div>
