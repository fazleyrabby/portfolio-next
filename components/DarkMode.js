...
export const DarkMode = () => {
    ...
    if(!mounted) return <button className='inline-flex p-3 hover:bg-gray-100 text-black dark:hover:text-black rounded  ml-auto  outline-none group overflow-hidden'>
    ...
    className="h-6 w-6 m-3 dark:stroke-white dark:group:sroke-white dark:group-hover:stroke-black rotate-0 transition-transform"
    fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /> </svg> : <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 m-3 rotate-90 transition-transform fill-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
