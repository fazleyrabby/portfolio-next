              ...
              <div className="flex justify-center" key={item.title}>
                <div className="rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition-transform bg-white max-w-md">
                  <a href={item.live || item.github || '#!'} target="_blank" data-mdb-ripple="true" data-mdb-ripple-color="light">
                    <img src={item.thumbnail} layout='fill' className='h-60 w-full object-cover object-left-top' />
                  </a>
                  <div className="p-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className='flex'>
                        {item.github ? <a href={item.github} target="_blank" className="inline-flex mr-2" title="Github">
                        ...
                        {item.live ? <a href={item.live} target="_blank" title="Link">
