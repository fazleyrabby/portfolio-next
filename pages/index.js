                  ...
                  <div className="p-3">
                    ...
                    <div className="flex justify-between">
                      <p className='flex space-x-1'>{item.tech?.map(each => (
                        <span className="px-3 py-1  border rounded-md text-slate-500 capitalize text-xs" key={each}>{each}</span>
                      ))}</p>
                      <div className='flex'>
                        {item.github ? <a target="_blank" href={item.github} rel="noreferrer " className="inline-flex mr-2" title="Github">
                        ...
                        {item.live ? <a target="_blank" href={item.live} rel="noreferrer " title="Link">
