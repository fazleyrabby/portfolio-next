          ...
          <div className='mx-auto space-y-2 lg:space-y-0 lg:gap-6 lg:grid lg:grid-cols-2'>
            {projects.map((item) => (
              <div class="flex justify-center" key={item.title}>
                <div class="rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition-transform bg-white max-w-md">
                  <a href={item.live || item.github || '#!'} data-mdb-ripple="true" data-mdb-ripple-color="light">
                  ...
                  <div class="p-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className='flex'>
                        {item.github ? <a href={item.github} class="inline-flex mr-2" title="Github">
                        ...
                        {item.live ? <a href={item.live} title="Link">
            ...
            <ol class="relative border-l border-gray-200 dark:border-gray-700">
              {experiences.map((item) => (
                <li class="mb-10 ml-4" key={item.name}>
                  ...
                  {item.contributions.length > 1 ? <ul class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">{item.contributions?.map(each => (<li className="mb-1">- {each}</li>))}</ul> : <p className='mb-4 text-base font-normal text-gray-500 dark:text-gray-400'>
