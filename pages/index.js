            ...
            {projects.map((item) => (
              <div className="flex justify-center" key={item.title}>
                <div className="rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition-transform bg-white max-w-md">
                  <a href={item.live || item.github || '#!'} target="_blank" data-mdb-ripple="true" data-mdb-ripple-color="light">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className='flex'>
                        {item.github ? <a target="_blank" href={item.github} className="inline-flex mr-2" title="Github">
                        ...
                        {item.live ? <a target="_blank" href={item.live} title="Link">
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
              {experiences.map((item) => (
                <li className="mb-10 ml-4" key={item.name}>
                  ...
                  <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{item.from} - {item.to}</time>
